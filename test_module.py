...
class UnitTests(unittest.TestCase):
    ...
    def test_port_scanner_verbose_ip_no_hostname_returned_single_port(self):
        ...
        actual = str
        expected = "Open ports for 104.26.10.78 (104.26.10.78)\nPORT     SERVICE\n443      https"
        self.assertEqual(actual, expected, "Expected 'Open ports for 104.26.10.78 (104.26.10.78)\nPORT     SERVICE\n443      https'")
    ...
    def test_port_scanner_verbose_ip_hostname_returned_multiple_ports(self):
        ...
        actual = str
        expected = "Open ports for 137.74.187.104 (137.74.187.104)\nPORT     SERVICE\n443      https"
        self.assertEqual(actual, expected, "Expected 'Open ports for 137.74.187.104 (137.74.187.104)\nPORT     SERVICE\n443      https'")
